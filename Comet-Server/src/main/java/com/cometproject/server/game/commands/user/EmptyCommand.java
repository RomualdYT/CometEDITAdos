...
public class EmptyCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        if (params.length != 1) {
            ...
            sendNotif(Locale.getOrDefault("command.empty.emptied", "Ton inventaire a été vidé."), client);
        } else {
            switch (params[0]) {
                default:
                ...
                case "pets":
                    ...
                    sendNotif(Locale.getOrDefault("command.empty.emptied_pets", "Ton inventaire a été vidé."), client);
                    return;
                ...
                case "bots":
                    ...
                    sendNotif(Locale.getOrDefault("command.empty.emptied_bots", "Ton inventaire a été vidé."), client);
                    return;
            }
        }
