...
import com.cometproject.server.network.messages.incoming.user.club.GetHabboClubWindowMessageEvent;
...
//        this.registerCamera();
    ...
    public void registerUser() {
        ...
        this.getMessages().put(Events.DisconnectionMessageEvent, new DisconnectionMessageEvent());
        ...
        this.getMessages().put(Events.FindNewFriendsMessageEvent, new FindNewFriendsMessageEvent());
    }
    ...
    public void registerItems() {
        ...
        this.getMessages().put(Events.GetHabboClubWindowMessageEvent, new GetHabboClubWindowMessageEvent());
